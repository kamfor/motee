...
#include "../serialreceiver/include/console.h"
...
QT_MOC_LITERAL(4, 22, 9) // "dataReady"

    },
    "Console\0getData\0\0data\0dataReady"
};
...
void Console::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->dataReady((*reinterpret_cast< bool(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (Console::*_t)(bool );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Console::dataReady)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 1
void Console::dataReady(bool _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
